...
class ViewController: UIViewController {
    ...
    func getPastDate() {
        ...
        print("基準日時の150日前を算出（減算）：" + String(pastDate.year!) + "年" + String(pastDate.month!) + "月" + String(pastDate.day!) + "日" + String(pastDate.hour!) + "時" + String(pastDate.minute!) + "分" + String(pastDate.second!) + "秒")
    }
}
